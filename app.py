...
prompts = [
    "Provide a 300 word summary for the document",
    "List any financial information that is present in the document",
    "Are there references to any Public Laws, other legislation, or regulations",
    "Does this impact Kearney & Company",
]
    ...
    if st.session_state['ready']:
        ...
        with container:
            with st.form(key='my_form', clear_on_submit=True):
                user_input = st.text_input("Query:", placeholder="e.g: Summarize the paper in a few sentences", key='input', value=user_input)
